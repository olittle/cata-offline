...
#
# Last Modified : Thu 05 Sep 2013 07:08:50 PM CDT
#
...
@outputSchema("AUC:float, AUPR:float, Pre_1:float, Pre_3:float, Pre_10:float,  NDCG_1:float, NDCG_3:float, NDCG_10:float")
def metrics(hits):
